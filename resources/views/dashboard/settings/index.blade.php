        ...
        <form action="{{ route('dashboard.settings.update', $setting->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control dropify" type="file" id="formFile" name="logo" data-default-file="{{ $setting->logo }}">
                </div>


                <div class="mb-3">
                    <label for="formFile" class="form-label">Favicon</label>
                    <input class="form-control dropify" type="file" id="formFile" name="favicon" data-default-file="{{ $setting->favicon }}">
                </div>
            ...
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" placeholder="Instagram" aria-label="Input group example"
                        aria-describedby="basic-addon1" name="instagram" value="{{ $setting->instagram }}">
                </div>
            </div>
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" placeholder="Youtube" aria-label="Input group example"
                        aria-describedby="basic-addon1" name="youtube" value="{{ $setting->youtube }}">
                </div>
            </div>
