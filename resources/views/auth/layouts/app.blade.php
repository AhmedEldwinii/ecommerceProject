        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                    <a class="navbar-brand d-inline-flex" href="{{ url('/') }}">
                        <img class="d-inline-block" src="{{ asset('dashboard') }}/assets/dist/img/logo.png" alt="logo"><span class="text-1000 fs-0 fw-bold ms-2">Majestic</span></a>
                     </a>
...
<!-- AdminLTE App -->
<script src="{{asset('dashboard')}}/assets//dist/js/adminlte.min.js"></script></body>
</html>
